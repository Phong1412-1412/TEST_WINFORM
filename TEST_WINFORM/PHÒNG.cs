    ...
    public partial class Phong : Form
    {
        ...
        private void ThongTinPhong(string qr,int tongPhong,int i)
        {
            ...
            for (i = 1; i <= tongPhong; i++)
            {
                ...
                btn_ChinhSuaPhong.Click += new System.EventHandler(buttonChinhSua);
        ...
        private void buttonChinhSua(object sender, EventArgs e)
        {
            Button current = (Button)sender;
            int MaPhong = int.Parse(current.Name);
            ThemPhongTro TPT = new ThemPhongTro(this,MaPhong,"SuaPhong");
            TPT.Show();
        }
        ...
        {
            DanhSachPhongTro LISTPT = new DanhSachPhongTro(this);
            LISTPT.Show();
        }
